...
description: Sign In template is a modern, user-friendly sign-in template designed to provide a seamless authentication experience. With clean layouts and responsive design, it ensures accessibility and simplicity for users across all devices.
template: splash
...
<TemplateOverview 
    ...
    data={{ 
        ...
        `,
        tags: ["Svelte", "TypeScript", "Authentication", "Responsive"],
