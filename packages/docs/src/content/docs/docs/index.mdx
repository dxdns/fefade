...
title: Introduction
description:
  navnex-kit is a lightweight and dependency-free UI component library, focused
  on performance, simplicity and clean code.
---

**navnex-kit** is a lightweight and dependency-free UI component library,
focused on performance, simplicity and clean code.
...
[**navnex-kit**](https://github.com/dxdns/navnex-kit) is provided as free and
...
Please see the
[Contributing Guide](https://github.com/dxdns/navnex-kit/blob/main/CONTRIBUTING.md)
for information on contributing to navnex-kit.
